...
public class CalculadoraCompleta {
	...
	public static void main(String[] args) {
		...
		case "a":
			...
			System.out.println("A soma entre os valore é: " + soma);
			break;
		...
		case "m":
			...
			System.out.println("A multiplicação entre os valore é: " + multiplicacao);
			break;
		...
		case "d":
			if (valor2 == 0) {
				...
				System.out.println("A divisão entre os valor é: " + divisao);
				break;
				
			}
			
		default:
			System.out.println("Operação não encontrada bisonho, faça de novo");
